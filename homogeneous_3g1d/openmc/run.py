...
groups = openmc.mgxs.EnergyGroups(group_edges=[1e-5, 1e1, 1e3, 2.0e6])

# Instantiate the cross section data
fuel_xsdata = openmc.XSdata('fuel', groups)
fuel_xsdata.order = 1
fuel_xsdata.set_total([1.1, 1.1, 1.0])
fuel_xsdata.set_absorption([0.4, 0.3, 0.2])
fuel_xsdata.set_scatter_matrix([[[0.4, 0.05], [0.2, 0.0], [0.1, 0.01]],
                                [[0.2, 0.0], [0.4, 0.0], [0.2, 0.0]],
                                [[0.2, 0.0], [0.2, 0.0], [0.4, 0.05]]])
fuel_xsdata.set_fission([0.3, 0.2, 0.1])
fuel_xsdata.set_nu_fission([0.6, 0.4, 0.2])
fuel_xsdata.set_chi([1.0, 0.0, 0.0])
