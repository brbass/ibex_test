...
m_fuel = openmc.Material(name='fuel', temperature=temp_fuel)
...
m_ifba = openmc.Material(name='ifba', temperature=temp_fuel)
...
m_gap = openmc.Material(name='gap', temperature=temp_fuel)
m_gap.set_density('g/cc', 0.0001786)
m_gap.add_nuclide(n2004, 2.68714e-05)

m_clad = openmc.Material(name='cladding', temperature=temp_mod)
...
m_mod = openmc.Material(name='moderator', temperature=temp_mod)
...
for cell in [c_fuel, c_ifba, c_gap, c_clad, c_mod]:
