...
clad_xsdata.order = 1
clad_xsdata.set_total([0.1])
clad_xsdata.set_absorption([0.0])
clad_xsdata.set_scatter_matrix([[[0.1, 0.02]]])

mod_xsdata = openmc.XSdata('mod', groups)
mod_xsdata.order = 1
mod_xsdata.set_total([2.0])
mod_xsdata.set_absorption([0.05])
mod_xsdata.set_scatter_matrix([[[1.95, 0.3]]])
