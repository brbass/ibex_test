...
m_fuel = openmc.Material(name='fuel', temperature=fuel_temperature)
...
m_gap = openmc.Material(name='gap', temperature=fuel_temperature)
m_gap.set_density('g/cc', 0.0001786)
m_gap.add_nuclide(n2004, 2.68714e-05)

m_clad = openmc.Material(name='cladding', temperature=mod_temperature)
...
m_mod = openmc.Material(name='moderator', temperature=mod_temperature)
...
# m_ifba = openmc.Material(name='ifba', temperature=temperature)
